...
require github.tools.sap/BTPFTechOffice/korifi/crd/extensions v0.0.0-20230213000009-14cd989a8b3d
...
require (
	...
	github.com/google/go-containerregistry/pkg/authn/kubernetes v0.0.0-20230217043738-4a0e0af4bf95 // indirect
	...
	knative.dev/pkg v0.0.0-20230215234751-2f55fe00c5a1 // indirect
